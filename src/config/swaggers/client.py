...
spectacular_settings = SpectacularSettings(
    user_settings=getattr(settings, 'SPECTACULAR_SETTINGS_CLIENT', {}),
    defaults=SPECTACULAR_DEFAULTS,
    import_strings=IMPORT_STRINGS,)



class ClientSpectacularAPIView(SpectacularAPIView):
...
class ClientSpectacularSwaggerView(SpectacularSwaggerView):
    url_name = "client_schema"
