...
spectacular_settings = SpectacularSettings(
    user_settings=getattr(settings, 'SPECTACULAR_SETTINGS_MERCHANT', {}),
    defaults=SPECTACULAR_DEFAULTS,
    import_strings=IMPORT_STRINGS,)


class MerchantSpectacularAPIView(SpectacularAPIView):
...
class MerchantSpectacularSwaggerView(SpectacularSwaggerView):
    url_name = "merchant_schema"
